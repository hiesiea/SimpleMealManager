...
class HomeViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if currentUser != nil && observing == false {
            ...
            // 要素が変更されたら該当のデータをpostArrayから一度削除した後に
            // 新しいデータを追加してTableViewを再表示する
        ...
        } else if currentUser == nil && observing == true {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        imageView.image = postArray[indexPath.row].getUIImage()
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        performSegue(withIdentifier: "Detail", sender: postArray[indexPath.row])
    }
}
